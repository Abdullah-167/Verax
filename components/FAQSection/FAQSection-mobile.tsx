              ...
              >
                ...
                <AccordionItem>
                  <h2>
                    ...
                    All the watches where produced with our own investment. We did not want to use the mint money. The mint money will be used to keep growing the community by launching a hoodie as the next mint and creating an event.
                      </AccordionPanel>
                </AccordionItem>
